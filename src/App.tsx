...
function MetaTags({ meta }: { meta: { title?: string; description?: string } }) {
  useEffect(() => {
    ...
    const org = { "@context": "https://schema.org", "@type": "Organization", name: "Flashfy", url: META.default.canonical, email: "flashfyonlinestore@gmail.com", logo: "/images/Logo.webp" };
...
export default function App() {
  ...
  const categories = [
    { id: "filters", title: "Filters (Industrial & HVAC)", desc: "EN ISO 16890 & EN 1822 compliant", img: "/images/filter.
import React, { useEffect, useState } from "react";
import { Menu, X, ChevronDown, CheckCircle } from "lucide-react";
...
export default function App() {
  ...
  const categories = [
    { id: "filters", title: "Filters (Industrial & HVAC)", desc: "EN ISO 16890 & EN 1822 compliant", img: "/images/filter.webp", text: filtersText },
    { id: "lights", title: "Lights (Emergency & General)", desc: "Facility & emergency luminaires", img: "/images/lights.webp", text: lightsText },
    { id: "gauges", title: "Gauges (Measurement & Process)", desc: "Dimensional & process gauges", img: "/images/gauges.webp", text: gaugesText },
    { id: "actuators", title: "Actuators & Valves", desc: "Reliable control components", img: "/images/actuators.webp", text: actuatorsText },
    { id: "smart", title: "Smart Devices", desc: "Smart locks, switches, cameras", img: "/images/smart.webp", text: smartText },
    { id: "property", title: "Property Management Essentials", desc: "We procure what you need", img: "/images/property.webp", text: propertyText },
  ] as const;
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-sky-200 flex items-center justify-between px-4 py-3 shadow relative">
        <button onClick={()=>setPage("home")} aria-label="Go to homepage">
          <img src="/images/Logo.webp" alt="Flashfy logo" className="h-10 w-auto rounded" />
        </button>
      ...
      {page === "home" && (
        <section className="relative w-full">
          <img src="/images/hero.webp" alt="Industrial supply and logistics hero" className="w-full h-[48vh] md:h-[62vh] object-cover" />
